...
1. Clone repository ini:
   ```sh
   [git clone [https://github.com/ahmadsidikrofi/be-budget-tracker.git](https://github.com/ahmadsidikrofi/be-budget-tracker.git)](https://github.com/ahmadsidikrofi/be-budget-tracker.git)
